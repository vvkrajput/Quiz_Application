...
public class QuizService {
    ...
    public ResponseEntity<String> createQuiz(String category, int noOFQuestions, String title) {
        List<Question> questions = questionDao.findRandomQuestion(category, noOFQuestions);
        Quiz quiz = new Quiz();
        quiz.setTitle(title);
